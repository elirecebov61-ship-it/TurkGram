...
public class MainPreferencesActivity extends BasePreferencesActivity {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        if (position == aboutExteraRow) {
            ...
            Browser.openUrl(getParentActivity(), "https://github.com/elirecebov61-ship-it/TurkGram");
        } else if (position == channelRow) {
            MessagesController.getInstance(currentAccount).openByUserName(("turkgrams"), this, 1);
        } else if (position == groupRow) {
            MessagesController.getInstance(currentAccount).openByUserName(("turkgramchat"), this, 1);
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (position == generalRow) {
                        ...
                        textCell.setTextAndValueAndIcon(LocaleController.getString("Channel", R.string.Channel), "@turkgrams", R.drawable.msg_channel, true);
                    } else if (position == groupRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("SearchAllChatsShort", R.string.SearchAllChatsShort), "@turkgramchat", R.drawable.msg_groups, true);
                    } else if (position == crowdinRow) {
